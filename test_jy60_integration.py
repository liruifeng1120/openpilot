...
def test_jy62_integration():
    ...
    # 检查locationd可执行文件
    locationd_path = '/home/$LOGNAME/ajouatom/selfdrive/locationd/locationd'
    if not os.path.exists(locationd_path):
        print("编译locationd...")
        result = subprocess.run([
            'scons', '--minimal', 'selfdrive/locationd/locationd'
        ], cwd='/home/$LOGNAME/ajouatom', capture_output=True, text=True)
    ...
    try:
        ...
        process = subprocess.Popen([
            ...
            '--device=/dev/ttyUSB0',
            '--baud=115200'
        ], cwd='/home/$LOGNAME/ajouatom', stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
def check_system_manager_config():
    ...
    config_path = '/home/$LOGNAME/ajouatom/system/manager/process_config.py'
