...
class DesireHelper:
  ...
  def update(self, carstate, lateral_active, lane_change_prob, carrotMan, radarState, modeldata, lat_plan_sp=None):
    ...
    amapNavi = None if self.sm is None else self.sm['amapNavi']
    ...
    if desire_enabled:
      ...
      carrot_left_blind = carrotMan.leftBlind or (False if amapNavi is None else amapNavi.leftBlind)
      carrot_right_blind = carrotMan.rightBlind or (False if amapNavi is None else amapNavi.rightBlind)
