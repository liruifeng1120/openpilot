...
from openpilot.selfdrive.carrot.web_interface import WebInterface
...
class AmapNaviServ:
  ...
  def _data_deal_thread(self):
    ...
    while True:
      try:
        self.sm.update(0)
        self.update_navi_carstate(self.sm)
...
def main():
  ...
  amap_navi.udp_recv_thread()
  amap_navi.web_interface.stop_web_server()
