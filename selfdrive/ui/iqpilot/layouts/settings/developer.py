...
class IQDeveloperLayout(DeveloperLayout):
  ...
  def _initialize_items(self):
    self.show_advanced_controls = toggle_item(tr("Show Advanced Controls"),
                                                 tr("Toggle visibility of advanced IQ.Pilot controls.<br>This only changes the visibility of the toggles; " +
                                                    "it does not change the actual enabled/disabled state."), param="ShowAdvancedControls")

    self.enable_github_runner_toggle = toggle_item(tr("GitHub Runner Service"), tr("Enables or disables the GitHub runner service."),
                                                      param="EnableGithubRunner")

    self.enable_copyparty_toggle = toggle_item(tr("copyparty Service"),
    ...
    self.prebuilt_toggle = toggle_item(tr("Quickboot Mode"), "", param="QuickBootToggle", callback=self._on_prebuilt_toggled)
