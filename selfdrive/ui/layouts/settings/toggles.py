...
class TogglesLayout(Widget):
  ...
  def _update_toggles(self):
    ...
    if not alpha_available and self._get_longitudinal_control_mode_index() != 0:
      self._apply_longitudinal_control_mode(0)
    ...
    longitudinal_control_item.action_item.set_enabled_buttons([True, alpha_available, alpha_available, alpha_available])
    ...
    personality_enabled = alpha_available and mode_index in (2, 3)
