...
if gui_app.iqpilot_ui():
  ...
  from openpilot.selfdrive.ui.iqpilot.onroad.driver_state import DriverStateRendererIQ as DriverStateRenderer
  from openpilot.selfdrive.ui.iqpilot.onroad.hud_renderer import IQHudRenderer as HudRenderer
...
class AugmentedRoadView(CameraView, AugmentedRoadViewIQ):
  ...
  def _render(self, rect):
    ...
    AugmentedRoadViewIQ.update_fade_out_bottom_overlay(self, self._content_rect)
