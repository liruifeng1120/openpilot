...
public:
  explicit OverlayDialog(QWidget* parent = nullptr) : QWidget(parent) {
    setWindowFlags(Qt::Window | Qt::FramelessWindowHint); // ���̾��α�ó�� ����
...
//#endif
  ...
  if (x > 40 && x < 370 && ey > 30 && ey < 240) {   // date & time
    ...
    UIState* s = uiState();
    s->scene._current_carrot_display = (s->scene._current_carrot_display % 3) + 1;  // 4��: full map�� �Ⱥ�����.
...
// OnroadWindow.cpp���� OpenGL �ʱ�ȭ �� �׸��� ����
void OnroadWindow::initializeGL() {
    initializeOpenGLFunctions(); // QOpenGLFunctions �ʱ�ȭ

    // Parent widget�� ���� NanoVG ���ؽ�Ʈ ����
