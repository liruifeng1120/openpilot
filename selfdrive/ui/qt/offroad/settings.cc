...
QPushButton* close_software_btn = new QPushButton(tr("关闭软件"));
close_software_btn->setObjectName("poweroff_btn");  // 使用关机按钮样式
init_layout->addWidget(close_software_btn);
QObject::connect(close_software_btn, &QPushButton::clicked, [&]() {
  if (ConfirmationDialog::confirm(tr("确定要关闭openpilot软件吗？"), tr("关闭软件"), this)) {
    params.putBool("DoSoftwareExit", true);  // 新参数，只关闭软件
  }
});
...
void DevicePanel::calibration() {
  if (!uiState()->engaged()) {
    ...
    calibOptions << tr("CalibrationParams") << tr("LiveDelay") << tr("LiveTorqueParameters");
...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  cruiseToggles->addItem(new CValueControl("TFollowGap1", tr("GAP1: Apply TFollow (110)x0.01s"), tr(""), "../assets/offroad/icon_road.png", 70, 300, 5));
  cruiseToggles->addItem(new CValueControl("TFollowGap2", tr("GAP2: Apply TFollow (120)x0.01s"), tr(""), "../assets/offroad/icon_road.png", 70, 300, 5));
  cruiseToggles->addItem(new CValueControl("TFollowGap3", tr("GAP3: Apply TFollow (160)x0.01s"), tr(""), "../assets/offroad/icon_road.png", 70, 300, 5));
  cruiseToggles->addItem(new CValueControl("TFollowGap4", tr("GAP4: Apply TFollow (180)x0.01s"), tr(""), "../assets/offroad/icon_road.png", 70, 300, 5));
  cruiseToggles->addItem(new CValueControl("DynamicTFollow", tr("Dynamic GAP control"), tr(""), "../assets/offroad/icon_road.png", 0, 100, 5));
  cruiseToggles->addItem(new CValueControl("DynamicTFollowLC", tr("Dynamic GAP control (LaneChange)"), tr(""), "../assets/offroad/icon_road.png", 0, 100, 5));
  ...
  //cruiseToggles->addItem(new CValueControl("MyEcoModeFactor", tr("DRIVEMODE: ECO Accel ratio(80%)"), tr("Acceleration ratio in ECO mode"), "../assets/offroad/icon_road.png", 10, 95, 5));
  //cruiseToggles->addItem(new CValueControl("MySafeModeFactor", tr("DRIVEMODE: SAFE ratio(60%)"), tr("Accel/StopDistance/DecelRatio/Gap control ratio"), "../assets/offroad/icon_road.png", 10, 90, 10));
  //cruiseToggles->addItem(new CValueControl("MyHighModeFactor", tr("DRIVEMODE: HIGH ratio(100%)"), tr("AccelRatio control ratio"), "../assets/offroad/icon_road.png", 100, 300, 10));

  latLongToggles = new ListWidget(this);
  //latLongToggles->addItem(new CValueControl("AutoLaneChangeSpeed", tr("LaneChangeSpeed(20)"), tr(""), "../assets/offroad/icon_road.png", 1, 100, 5));
  ...
  latLongToggles->addItem(new CValueControl("AdjustLaneOffset", tr("AdjustLaneOffset(0)cm"), tr(""), "../assets/offroad/icon_logic.png", 0, 500, 5));
  latLongToggles->addItem(new CValueControl("AdjustCurveOffset", tr("Curve Offset Adjust(0)cm"), tr("Curve offset compensation"), "../assets/offroad/icon_road.png", -500, 500, 10));
  ...
  latLongToggles->addItem(new CValueControl("LongTuningKpV", tr("LONG: P Gain(100)"), tr(""), "../assets/offroad/icon_logic.png", 0, 150, 5));
  latLongToggles->addItem(new CValueControl("LongTuningKiV", tr("LONG: I Gain(0)"), tr(""), "../assets/offroad/icon_logic.png", 0, 2000, 5));
  latLongToggles->addItem(new CValueControl("LongTuningKf", tr("LONG: FF Gain(100)"), tr(""), "../assets/offroad/icon_logic.png", 0, 200, 5));
  latLongToggles->addItem(new CValueControl("LongActuatorDelay", tr("LONG: ActuatorDelay(20)"), tr(""), "../assets/offroad/icon_logic.png", 0, 200, 5));
  ...
  latLongToggles->addItem(new CValueControl("RadarReactionFactor", tr("LONG: Radar reaction factor(100)"), tr(""), "../assets/offroad/icon_logic.png", 0, 200, 10));
  ...
  latLongToggles->addItem(new CValueControl("StoppingAccel", tr("LONG: StoppingStartAccelx0.01(-40)"), tr(""), "../assets/offroad/icon_logic.png", -100, 0, 5));
  latLongToggles->addItem(new CValueControl("StopDistanceCarrot", tr("LONG: StopDistance (600)cm"), tr(""), "../assets/offroad/icon_logic.png", 300, 1000, 10));
  //latLongToggles->addItem(new CValueControl("TraffStopDistanceAdjust", tr("LONG: TrafficStopDistance adjust(150)cm"), tr(""), "../assets/offroad/icon_road.png", -1000, 1000, 10));
  ...
  latLongToggles->addItem(new CValueControl("LateralTorqueCustom", tr("LAT: TorqueCustom(0)"), tr(""), "../assets/offroad/icon_logic.png", 0, 2, 1));
  latLongToggles->addItem(new CValueControl("LateralTorqueAccelFactor", tr("LAT: TorqueAccelFactor(2500)"), tr(""), "../assets/offroad/icon_logic.png", 1000, 6000, 10));
  latLongToggles->addItem(new CValueControl("LateralTorqueFriction", tr("LAT: TorqueFriction(100)"), tr(""), "../assets/offroad/icon_logic.png", 0, 1000, 10));
  latLongToggles->addItem(new CValueControl("CustomSteerMax", tr("LAT: CustomSteerMax(0)"), tr(""), "../assets/offroad/icon_logic.png", 0, 30000, 5));
  latLongToggles->addItem(new CValueControl("CustomSteerDeltaUp", tr("LAT: CustomSteerDeltaUp(0)"), tr(""), "../assets/offroad/icon_logic.png", 0, 50, 1));
  latLongToggles->addItem(new CValueControl("CustomSteerDeltaDown", tr("LAT: CustomSteerDeltaDown(0)"), tr(""), "../assets/offroad/icon_logic.png", 0, 50, 1));
  ...
  dispToggles->addItem(new CValueControl("ShowDebugUI", tr("DISP:Debug Info"), tr(""), "../assets/offroad/icon_shell.png", 0, 2, 1));
  dispToggles->addItem(new CValueControl("ShowTpms", tr("DISP:Tpms Info"), tr(""), "../assets/offroad/icon_shell.png", 0, 3, 1));
  ...
  dispToggles->addItem(new CValueControl("ShowPlotMode", tr("DISP:Debug plot"), tr(""), "../assets/offroad/icon_shell.png", 0, 10, 1));
  dispToggles->addItem(new CValueControl("ShowCustomBrightness", tr("Brightness ratio"), tr(""), "../assets/offroad/icon_brightness.png", 0, 100, 10));
  ...
  pathToggles->addItem(new CValueControl("ShowPathWidth", tr("DISP:Path Width ratio(100%)"), tr(""), "../assets/offroad/icon_shell.png", 10, 200, 10));
  ...
  startToggles->addItem(new ParamControl("IsLdwsCar", tr("IsLdwsCar"), tr(""), "../assets/offroad/icon_road.png", this));
  ...
  startToggles->addItem(new CValueControl("RadarVisionMode", tr("Radar Vision Mode"), tr("0:Fusion,1:Radar Only,2:Vision Only"), "../assets/offroad/icon_shell.png", 0, 2, 1));
  startToggles->addItem(new ParamControl("BydAutoTuning", tr("BYD Auto Tuning"), tr("Enable automatic torque parameter tuning"), "../assets/offroad/icon_road.png", this));
  startToggles->addItem(new ParamControl("BydLatUseSiglin", tr("BYD Use Siglin Mode"), tr("Use siglin non-linear torque calculation"), "../assets/offroad/icon_road.png", this));
  startToggles->addItem(new ParamControl("BydModifiedStockLong", tr("BYD Modified Stock Long"), tr("Enable modified stock longitudinal control"), "../assets/offroad/icon_road.png", this));
  ...
  startToggles->addItem(new ParamControl("DisableMinSteerSpeed", tr("Disable Min.SteerSpeed (Eg. SMDPS"), tr(""), "../assets/offroad/icon_road.png", this));
  ...
  startToggles->addItem(new ParamControl("AutoGasSyncSpeed", tr("Auto update Cruise speed"), tr(""), "../assets/offroad/icon_road.png", this));
  ...
  startToggles->addItem(new CValueControl("SoundVolumeAdjust", tr("Sound Volume(100%)"), tr(""), "../assets/offroad/icon_sound.png", 5, 200, 5));
  startToggles->addItem(new CValueControl("SoundVolumeAdjustEngage", tr("Sound Volume, Engage(10%)"), tr(""), "../assets/offroad/icon_sound.png", 5, 200, 5));
  startToggles->addItem(new CValueControl("MaxTimeOffroadMin", tr("Power off time (min)"), tr(""), "../assets/offroad/icon_sandtimer.png", 1, 600, 10));
  startToggles->addItem(new ParamControl("DisableDM", tr("Disable DM"), tr(""), "../assets/img_driver_face_static_x.png", this));
  ...
  //startToggles->addItem(new CValueControl("CarrotCountDownSpeed", tr("NaviCountDown Speed(10)"), tr(""), "../assets/offroad/icon_shell.png", 0, 200, 5));
  startToggles->addItem(new CValueControl("MapboxStyle", tr("Mapbox Style(0)"), tr(""), "../assets/offroad/icon_shell.png", 0, 2, 1));
  ...
  startToggles->addItem(new ParamControl("HotspotOnBoot", tr("Hotspot enabled on boot"), tr(""), "../assets/offroad/icon_shell.png", this));
  startToggles->addItem(new ParamControl("SoftwareMenu", tr("Enable Software Menu"), tr(""), "../assets/offroad/icon_shell.png", this));
  //startToggles->addItem(new ParamControl("NoLogging", tr("Disable Logger"), tr(""), "../assets/offroad/icon_shell.png", this));
  //startToggles->addItem(new ParamControl("LaneChangeNeedTorque", tr("LaneChange: Need Torque"), tr(""), "../assets/offroad/icon_shell.png", this));
  ...
  speedToggles->addItem(new CValueControl("AutoCurveSpeedFactor", tr("CURVE: Auto Control ratio(100%)"), tr(""), "../assets/offroad/icon_road.png", 50, 300, 1));
  speedToggles->addItem(new CValueControl("AutoCurveSpeedAggressiveness", tr("CURVE: Aggressiveness (100%)"), tr(""), "../assets/offroad/icon_road.png", 50, 300, 1));
  ...
  speedToggles->addItem(new CValueControl("AutoNaviSpeedSafetyFactor", tr("SpeedCameraSafetyFactor(105%)"), tr(""), "../assets/offroad/icon_road.png", 80, 120, 1));
  speedToggles->addItem(new CValueControl("AutoNaviSpeedBumpTime", tr("SpeedBumpTimeDistance(1s)"), tr(""), "../assets/offroad/icon_road.png", 1, 50, 1));
  speedToggles->addItem(new CValueControl("AutoNaviSpeedBumpSpeed", tr("SpeedBumpSpeed(35Km/h)"), tr(""), "../assets/offroad/icon_road.png", 10, 100, 5));
  ...
  speedToggles->addItem(new CValueControl("MapTurnSpeedFactor", tr("Map TurnSpeed Factor(100)"), tr(""), "../assets/offroad/icon_map.png", 50, 300, 5));
  ...
  speedToggles->addItem(new CValueControl("AutoRoadSpeedAdjust", tr("Auto Roadlimit Speed adjust (50%)"), tr(""), "../assets/offroad/icon_road.png", -1, 100, 5));
  speedToggles->addItem(new CValueControl("AutoTurnMapChange", tr("ATC Auto Map Change(0)"), tr(""), "../assets/offroad/icon_road.png", 0, 1, 1));
