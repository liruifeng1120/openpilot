...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  cruiseToggles->addItem(new CValueControl("CruiseSpeedUnit", tr("Button: Cruise Speed Unit"), "", 1, 20, 1));
  ...
  cruiseToggles->addItem(new CValueControl("CruiseSpeedMin", tr("CRUISE: Speed Lower limit(10)"), tr("Cruise control MIN speed"), 5, 50, 1));
  cruiseToggles->addItem(new CValueControl("AutoResumeFromGas", tr("GAS CRUISE ON: Use"), tr("Auto Cruise on when GAS pedal released, 60% Gas Cruise On automatically"), 0, 3, 1));
  cruiseToggles->addItem(new CValueControl("AutoResumeFromGasSpeed", tr("GAS CRUISE ON: Speed(30)"), tr("Driving speed exceeds the set value, Cruise ON"), 20, 140, 5));
  cruiseToggles->addItem(new CValueControl("TFollowSpeedAddM", tr("GAP: Additional TFs 40km/h(0)x0.01s"), tr("Speed-dependent additional max(100km/h) TFs"), -100, 200, 5));
  cruiseToggles->addItem(new CValueControl("TFollowSpeedAdd", tr("GAP: Additional TFs 100Km/h(0)x0.01s"), tr("Speed-dependent additional max(100km/h) TFs"), -100, 200, 5));
  ...
  cruiseToggles->addItem(new CValueControl("MyEcoModeFactor", tr("DRIVEMODE: ECO Accel ratio(80%)"), tr("Acceleration ratio in ECO mode"), 10, 95, 5));
  cruiseToggles->addItem(new CValueControl("MySafeModeFactor", tr("DRIVEMODE: SAFE ratio(60%)"), tr("Accel/StopDistance/DecelRatio/Gap control ratio"), 10, 90, 10));
  cruiseToggles->addItem(new CValueControl("MyHighModeFactor", tr("DRIVEMODE: HIGH ratio(100%)"), tr("AccelRatio control ratio"), 100, 300, 10));

  latLongToggles = new ListWidget(this);
  latLongToggles->addItem(new CValueControl("AutoLaneChangeSpeed", tr("LaneChangeSpeed(20)"), "", 1, 100, 5));
  ...
  latLongToggles->addItem(new CValueControl("JerkStartLimit", tr("LONG: JERK START(10)x0.1"), tr("Starting Jerk."), 1, 50, 1));
  latLongToggles->addItem(new CValueControl("LongitudinalTuningApi", tr("LONG: ControlType"), tr("0:velocity pid, 1:accel pid, 2:accel pid(comma)"), 0, 2, 1));
  latLongToggles->addItem(new CValueControl("StartAccelApply", tr("LONG: StartingAccel 2.0x(0)%"), tr("Specifies the acceleration rate when starting from stop. 0: Disabled."), 0, 100, 10));
  latLongToggles->addItem(new CValueControl("StopAccelApply", tr("LONG: StoppingAccel -2.0x(0)%"), tr("Adjusts brake pressure when maintaining stop. 0: Disabled."), 0, 100, 10));
  latLongToggles->addItem(new CValueControl("TraffStopDistanceAdjust", tr("LONG: TrafficStopDistance adjust(150)cm"), "", -1000, 1000, 10));
  latLongToggles->addItem(new CValueControl("CruiseMinVals", tr("DECEL:(120)"), tr("Sets the deceleration rate.(x0.01m/s^2)"), 50, 250, 5));
  dispToggles = new ListWidget(this);
  dispToggles->addItem(new CValueControl("ShowDebugUI", tr("DISP:Debug Info"), "", 0, 2, 1));
  dispToggles->addItem(new CValueControl("ShowTpms", tr("DISP:Tpms Info"), "", 0, 3, 1));
  dispToggles->addItem(new CValueControl("ShowDateTime", tr("DISP:Time Info"), tr("0:None,1:Time/Date,2:Time,3:Date"), 0, 3, 1));
  dispToggles->addItem(new CValueControl("ShowPathEnd", tr("DISP:Path End"), tr("0:None,1:Display"), 0, 1, 1));
  dispToggles->addItem(new CValueControl("ShowDeviceState", tr("DISP:Device State"), tr("0:None,1:Display"), 0, 1, 1));
  dispToggles->addItem(new CValueControl("ShowLaneInfo", tr("DISP:Lane Info"), tr("-1:None, 0:Path, 1:Path+Lane, 2: Path+Lane+RoadEdge"), -1, 2, 1));
  dispToggles->addItem(new CValueControl("ShowRadarInfo", tr("DISP:Radar Info"), tr("0:None,1:Display,2:RelPos,3:Stopped Car"), 0, 3, 1));
  dispToggles->addItem(new CValueControl("ShowRouteInfo", tr("DISP:Route Info"), tr("0:None,1:Display"), 0, 1, 1));
  dispToggles->addItem(new CValueControl("ShowPlotMode", tr("DISP:Debug plot"), "", 0, 10, 1));
  dispToggles->addItem(new CValueControl("ShowCustomBrightness", tr("Brightness ratio"), "", 0, 100, 10));
  dispToggles->addItem(new CValueControl("ShowHudMode", tr("DISP:Display Mode"), tr("0:Frog,1:APilot,2:Bottom,3:Top,4:Left,5:Left-Bottom"), 0, 5, 1));
  dispToggles->addItem(new CValueControl("ShowSteerRotate", tr("DISP:Handle rotate"), tr("0:None,1:Rotate"), 0, 1, 1));
  dispToggles->addItem(new CValueControl("ShowAccelRpm", tr("DISP:Accel meter"), tr("0:None,1:Display,1:Accel+RPM"), 0, 2, 1));
  dispToggles->addItem(new CValueControl("ShowTpms", tr("DISP:TPMS"), tr("0:None,1:Display"), 0, 1, 1));
  dispToggles->addItem(new CValueControl("ShowSteerMode", tr("DISP:Handle Display Mode"), tr("0:Black,1:Color,2:None"), 0, 2, 1));
  dispToggles->addItem(new CValueControl("ShowConnInfo", tr("DISP:APM connection"), tr("0:NOne,1:Display"), 0, 1, 1));
  dispToggles->addItem(new CValueControl("ShowBlindSpot", tr("DISP:BSD Info"), tr("0:None,1:Display"), 0, 1, 1));
  dispToggles->addItem(new CValueControl("ShowGapInfo", tr("DISP:GAP Info"), tr("0:None,1:Display"), -1, 1, 1));
  dispToggles->addItem(new CValueControl("ShowDmInfo", tr("DISP:DM Info"), tr("0:None,1:Display,-1:Disable(Reboot)"), -1, 1, 1));

  pathToggles = new ListWidget(this);
  pathToggles->addItem(new CValueControl("ShowPathModeCruiseOff", tr("DISP: Path Mode: Cruise OFF"), tr("0:Normal,1,2:Rec,3,4:^^,5,6:Rec,7,8:^^,9,10,11,12:Smooth^^"), 0, 15, 1));
  pathToggles->addItem(new CValueControl("ShowPathColorCruiseOff", tr("DISP: Path Color: Cruise OFF"), tr("(+10:Stroke)0:Red,1:Orange,2:Yellow,3:Green,4:Blue,5:Indigo,6:Violet,7:Brown,8:White,9:Black"), 0, 19, 1));
  pathToggles->addItem(new CValueControl("ShowPathMode", tr("DISP:Path Mode: Laneless"), tr("0:Normal,1,2:Rec,3,4:^^,5,6:Rec,7,8:^^,9,10,11,12:Smooth^^"), 0, 15, 1));
  pathToggles->addItem(new CValueControl("ShowPathColor", tr("DISP:Path Color: Laneless"), tr("(+10:Stroke)0:Red,1:Orange,2:Yellow,3:Green,4:Blue,5:Indigo,6:Violet,7:Brown,8:White,9:Black"), 0, 19, 1));
  pathToggles->addItem(new CValueControl("ShowPathModeLane", tr("DISP:Path Mode: LaneMode"), tr("0:Normal,1,2:Rec,3,4:^^,5,6:Rec,7,8:^^,9,10,11,12:Smooth^^"), 0, 15, 1));
  pathToggles->addItem(new CValueControl("ShowPathColorLane", tr("DISP:Path Color: LaneMode"), tr("(+10:Stroke)0:Red,1:Orange,2:Yellow,3:Green,4:Blue,5:Indigo,6:Violet,7:Brown,8:White,9:Black"), 0, 19, 1));
  pathToggles->addItem(new CValueControl("ShowPathWidth", tr("DISP:Path Width ratio(100%)"), "", 10, 200, 10));
  ...
  startToggles->addItem(new CValueControl("EnableRadarTracks", tr("Enable Radar Track"), tr("1:Enable RadarTrack, -1,2:Disable use HKG SCC radar at all times"), -1, 2, 1));
  ...
  startToggles->addItem(new CValueControl("EnableConnect", tr("EnableConnect"), tr("Your device may be banned by Comma"), 0, 1, 1));
  ...
  startToggles->addItem(new CValueControl("CarrotCountDownSpeed", tr("NaviCountDown Speed(10)"), "", 0, 200, 5));
  ...
  startToggles->addItem(new CValueControl("LaneChangeLaneCheck", tr("LaneChange: Check lane exist"), tr("(0:No,1:Lane,2:+Edge)"), 0, 2, 1));
  ...
  speedToggles->addItem(new CValueControl("AutoNaviSpeedCtrlEnd", tr("SpeedCameraDecelEnd(6s)"), tr("Sets the deceleration completion point. A larger value completes deceleration farther away from the camera."), 3, 20, 1));
  ...
  speedToggles->addItem(new CValueControl("AutoNaviSpeedDecelRate", tr("SpeedCameraDecelRatex0.01m/s^2(80)"), tr("Lower number, slows down from a greater distance"), 10, 200, 10));
  speedToggles->addItem(new CValueControl("AutoNaviSpeedSafetyFactor", tr("SpeedCameraSafetyFactor(105%)"), "", 80, 120, 1));
