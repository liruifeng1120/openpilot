...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  connect(selectCarBtn, &QPushButton::clicked, [=]() {
    ...
    all_items.append(get_list((QString::fromStdString(Params().getParamPath()) + "/SupportedCars_hyundai").toStdString().c_str()));
    all_items.append(get_list((QString::fromStdString(Params().getParamPath()) + "/SupportedCars_lexus").toStdString().c_str()));
