...
inline static std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"LastUpdatePkg", PERSISTENT},
    {"BYDSnG", PERSISTENT},
    {"BYDForceTorqueFix", PERSISTENT},
    {"BYDHandsoffFix", PERSISTENT},
    {"BYDForceLowTorqueFactor", PERSISTENT},
    {"BYDReverseAccCAN", PERSISTENT},
    {"BYDReverseBsmCAN", PERSISTENT},
    {"BYDAngleControlOffset", PERSISTENT},
    {"PDDumpBuffer", PERSISTENT},
    {"DisableMADS", PERSISTENT},
    {"IsExternalViewEnabled", CLEAR_ON_MANAGER_START},
};
