...
class MetaDriveBridge(SimulatorBridge):
  ...
  def __init__(self, dual_camera, high_quality, test_duration=math.inf, test_run=False, config=None):
    self.config = config or {}
    car_brand = self.config.get("vehicle_config", {}).get("vehicle_model", "BYD").lower()
    super().__init__(dual_camera, high_quality, car_brand)
