...
from openpilot.iqpilot.navd.helpers import coordinate_from_param, Coordinate
from openpilot.iqpilot.selfdrive.controls.lib.smart_cruise_control import MIN_V

MapState = VisionState = custom.IQPlan.SmartCruiseControl.MapState
