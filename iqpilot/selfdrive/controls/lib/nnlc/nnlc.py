...
from openpilot.iqpilot.selfdrive.controls.lib.latcontrol_torque_ext_base import LatControlTorqueExtBase, sign
from openpilot.iqpilot.selfdrive.controls.lib.nnlc.helpers import MOCK_MODEL_PATH
from openpilot.iqpilot.selfdrive.controls.lib.nnlc.model import NNTorqueModel
...
class NeuralNetworkLateralControl(LatControlTorqueExtBase):
  def __init__(self, lac_torque, CP, CP_IQ, CI):
    ...
    self.has_nn_model = CP_IQ.neuralNetworkLateralControl.model.path != MOCK_MODEL_PATH

    # NN model takes current v_ego, lateral_accel, lat accel/jerk error, roll, and past/future/planned data
    # of lat accel and roll
    # Past value is computed using previous desired lat accel and observed roll
    self.model = NNTorqueModel(CP_IQ.neuralNetworkLateralControl.model.path)
