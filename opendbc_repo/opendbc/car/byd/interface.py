...
NON_LINEAR_TORQUE_PARAMS = {
  CAR.BYD_HAN_DM_20: [1.650, 1.520, 0.050],  # 调整非线性参数，增加线性分量以改善转向响应
  CAR.BYD_HAN_EV_20: [1.650, 1.520, 0.050],  # 调整非线性参数，增加线性分量以改善转向响应
...
class CarInterface(CarInterfaceBase):
    ...
    def _get_params(ret: structs.CarParams, candidate, fingerprint, car_fw, experimental_long, is_release, docs) -> structs.CarParams:
        ...
        ret.steerActuatorDelay = 0.03  # 进一步减少转向执行器延迟，确保车辆能够及时纠正到车道中央
        ...
        if use_torque_lat:
            ...
            ret.lateralTuning.torque.latAccelFactor = 2.0
        ...
        # Apply speed correction parameters from tuning.py
        ret.longitudinalTuning.kpBP, ret.longitudinalTuning.kiBP = [Tuning.DASHSPEED_BP, Tuning.DASHSPEED_BP]
        ret.longitudinalTuning.kpV,  ret.longitudinalTuning.kiV  = [Tuning.DASHSPEED_FP, Tuning.DASHSPEED_FP]
