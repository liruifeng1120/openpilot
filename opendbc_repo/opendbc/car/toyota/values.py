...
class CAR(Platforms):
  ...
  TOYOTA_CAMRY = PlatformConfig(
    [
      ToyotaCarDocs("Toyota Camry 2018-20", footnotes=[Footnote.CAMRY]),
  ...
  TOYOTA_HIGHLANDER = PlatformConfig(
    [
      ToyotaCarDocs("Toyota Highlander 2017-19"),
  ...
  TOYOTA_PRIUS = PlatformConfig(
    [
      ...
      ToyotaCarDocs("Toyota Prius Prime 2017-20"),
    ],
  ...
  TOYOTA_PRIUS_TSS2 = ToyotaTSS2PlatformConfig(
    [
      ...
      ToyotaCarDocs("Toyota Prius Prime 2021-22"),
    ],
  ...
  TOYOTA_RAV4_TSS2_2023 = ToyotaTSS2PlatformConfig(
    [
      ...
      ToyotaCarDocs("Toyota RAV4 Hybrid 2023-25"),
    ],
    TOYOTA_RAV4_TSS2.specs,
  ...
  TOYOTA_SIENNA = PlatformConfig(
    [ToyotaCarDocs("Toyota Sienna 2018-20", min_enable_speed=MIN_ACC_SPEED)],
