...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"TermsVersion", {PERSISTENT, STRING, "2"}},        // keep in sync with terms_version in system/version.py
    {"TrainingVersion", {PERSISTENT, STRING, "0.2.0"}}, // keep in sync with training_version in system/version.py; qt/offroad/onboarding.cc compares CompletedTrainingVersion against this
