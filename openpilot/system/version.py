...
# keep in sync with the TermsVersion/TrainingVersion defaults in common/params_keys.h:
# the Qt onboarding (selfdrive/ui/qt/offroad/onboarding.cc) reads them from params.
